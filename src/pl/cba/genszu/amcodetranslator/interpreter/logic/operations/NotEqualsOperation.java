...
public class NotEqualsOperation extends ArithmeticOperation {
    ...
    public Variable performOperation(StringVariable var1, StringVariable var2) {
        return VariableFactory.createVariable("BOOL", "", !var1.GET().equals(var2.GET()));
    }
    ...
    public Variable performOperation(StringVariable var1, IntegerVariable var2) {
        return VariableFactory.createVariable("BOOL", "", !(""+var2.GET()).equals(var1.GET()));
    }
    ...
    public Variable performOperation(BoolVariable var1, StringVariable var2) {
        return VariableFactory.createVariable("BOOL", "", true); // raczej zwraca true
    }
    ...
    public Variable performOperation(BoolVariable var1, IntegerVariable var2) {
        return VariableFactory.createVariable("BOOL", "", !(var1.GET() && (var2.GET() != 0))); // zakładam, że 1 == TRUE
    }

    @Override
    public Variable performOperation(IntegerVariable var1, BoolVariable var2) {
        return VariableFactory.createVariable("BOOL", "", !((var1.GET() != 0) && var2.GET())); // zakładam, że 1 == TRUE
    }
