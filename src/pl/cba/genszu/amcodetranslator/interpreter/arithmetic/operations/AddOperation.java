...
public class AddOperation extends ArithmeticOperation {
    ...
    public Variable performOperation(StringVariable var1, DoubleVariable var2) {
        ...
        return VariableFactory.createVariable("STRING", null, var1.GET() + formatter.format(var2.GET()), var1.getContext());
    }
    ...
    public Variable performOperation(IntegerVariable var1, DoubleVariable var2) {
        return VariableFactory.createVariable("INTEGER", null, Math.round(var1.GET() + var2.GET()), var1.getContext()); // castuje do inta i zaokrągla
    }
    ...
    public Variable performOperation(BoolVariable var1, StringVariable var2) {
        return VariableFactory.createVariable("BOOL", null, false, var1.getContext()); // wygląda, że zwraca false
    }

    @Override
    public Variable performOperation(StringVariable var1, BoolVariable var2) {
        return VariableFactory.createVariable("STRING", null, var1.GET()+(var2.GET() ? "TRUE" : "FALSE"), var1.getContext()); // dodaje literalnie TRUE lub FALSE
    }

    @Override
    public Variable performOperation(BoolVariable var1, BoolVariable var2) {
        return VariableFactory.createVariable("BOOL", null, var1.GET() || var2.GET(), var1.getContext());
    }

    @Override
    public Variable performOperation(BoolVariable var1, IntegerVariable var2) {
        return VariableFactory.createVariable("BOOL", null, var1.GET() || (var2.GET() != 0), var1.getContext());
    }

    @Override
    public Variable performOperation(IntegerVariable var1, BoolVariable var2) {
        return VariableFactory.createVariable("INTEGER", null, var1.GET() + (var2.GET() ? 1 : 0), var1.getContext());
    }
    ...
    public Variable performOperation(DoubleVariable var1, BoolVariable var2) {
        return VariableFactory.createVariable("DOUBLE", null, var1.GET() + (var2.GET() ? 1 : 0), var1.getContext());
    }
}
