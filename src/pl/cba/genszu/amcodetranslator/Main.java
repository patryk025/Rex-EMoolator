...
public class Main
{
	...
	{
		//String testExpression = "{@RETURN([2+2*2]);}";
		...
		//String testExpression = "{@RETURN([15-1*[12@4+1]]);}";
		//String testExpression = "{@RETURN([6@2*(1+2)]);}";
		...
		//String testExpression = "{@RETURN([TEST^ADD(TEST_COMPARE)]);}";
		...
		context.setVariable("TEST_COMPARE", new StringVariable("TEST_COMPARE", "3", context));
		context.setVariable("TEST2_COMPARE", new IntegerVariable("TEST2_COMPARE", 2, context));
		context.setVariable("TEST3_COMPARE", new DoubleVariable("TEST3_COMPARE", -2.5, context));
		context.setVariable("TEST4_COMPARE", new IntegerVariable("TEST4_COMPARE", -3, context));
