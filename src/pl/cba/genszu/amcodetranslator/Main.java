...
public class Main {
    ...
    public static void main(String[] args) {
		...
		try
		{
			cp.parseFile(new File("/sdcard/skrypty/riu(7.1)/DANE/ReksioUfo/PRZYGODA/Wyscigi/s67_Wyscigi.cnv"));
			List<Variable> vars = cp.variables;
			String debugCode = CNVReconstructor.reconstruct(vars);
