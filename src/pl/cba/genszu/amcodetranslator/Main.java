...
public class Main
{
    ...
    public static void main(String[] args)
	{
		...
		/*try
		 {
		 FileReader reader = new FileReader("/sdcard/skrypty/risp/Dane/Intro/MainMenu/24laser/24LASER.cnv");
		 ...
		 PrintWriter pw = new PrintWriter("/sdcard/skrypty/24LASER.cnv.dek");
