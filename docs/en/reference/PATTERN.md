...
**Compatibility:** `GETGRAPHICSAT` - `PIKLIB61.DLL` ❌, `PIKLIB71.DLL` ❌, `PIKLIB72.DLL` ❌, `PIKLIB8.DLL` ⚠️ (9/10), `BlooMooWEB.dll` ✅, `BlooMooDLL.dll` ✅.
...
**Compatibility:** `MOVE` - `PIKLIB61.DLL` ❌, `PIKLIB71.DLL` ❌, `PIKLIB72.DLL` ❌, `PIKLIB8.DLL` ⚠️ (9/10), `BlooMooWEB.dll` ✅, `BlooMooDLL.dll` ✅.
