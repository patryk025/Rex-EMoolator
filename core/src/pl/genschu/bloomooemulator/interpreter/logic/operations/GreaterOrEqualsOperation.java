...
public class GreaterOrEqualsOperation extends ArithmeticOperation {
    @Override
    public Variable performOperation(StringVariable var1, StringVariable var2) {
        return LegacyVariableFactory.createVariable("BOOL", "", var1.GET().compareTo(var2.GET()) >= 0, var1.getContext());
    }
    ...
    public Variable performOperation(StringVariable var1, IntegerVariable var2) {
        return LegacyVariableFactory.createVariable("BOOL", "", var1.GET().compareTo(var2.toStringVariable()) >= 0, var1.getContext());
    }
    ...
    public Variable performOperation(BoolVariable var1, StringVariable var2) {
        return LegacyVariableFactory.createVariable("BOOL", "", var1.toInt() >= (var2.toBool() ? 1 : 0), var1.getContext());
    }
    ...
    public Variable performOperation(BoolVariable var1, BoolVariable var2) {
        return LegacyVariableFactory.createVariable("BOOL", "", var1.toInt() >= var2.toInt(), var1.getContext());
    }

    @Override
    public Variable performOperation(BoolVariable var1, IntegerVariable var2) {
        return LegacyVariableFactory.createVariable("BOOL", "", var1.toInt() >= var2.clipToBool(), var1.getContext());
    }
    ...
    public Variable performOperation(BoolVariable var1, DoubleVariable var2) {
        return LegacyVariableFactory.createVariable("BOOL", "", var1.toDouble() >= var2.clipToBool(), var1.getContext());
    }
