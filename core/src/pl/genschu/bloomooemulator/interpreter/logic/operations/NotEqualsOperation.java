...
public class NotEqualsOperation extends ArithmeticOperation {
    @Override
    public Variable performOperation(StringVariable var1, StringVariable var2) {
        return LegacyVariableFactory.createVariable("BOOL", "", !var1.GET().equals(var2.GET()), var1.getContext());
    }

    @Override
    public Variable performOperation(IntegerVariable var1, StringVariable var2) {
        return LegacyVariableFactory.createVariable("BOOL", "", var1.GET() != var2.toInt(), var1.getContext());
    }

    @Override
    public Variable performOperation(StringVariable var1, IntegerVariable var2) {
        return LegacyVariableFactory.createVariable("BOOL", "", !var1.GET().equals(var2.toStringVariable()), var1.getContext());
    }

    @Override
    public Variable performOperation(DoubleVariable var1, StringVariable var2) {
        return LegacyVariableFactory.createVariable("BOOL", "", var1.GET() != var2.toDouble(), var1.getContext());
    }
    ...
    public Variable performOperation(BoolVariable var1, StringVariable var2) {
        return LegacyVariableFactory.createVariable("BOOL", "", var1.GET() != var2.toBool(), var1.getContext()); // raczej zwraca false'a
    }

    @Override
    public Variable performOperation(StringVariable var1, BoolVariable var2) {
        return LegacyVariableFactory.createVariable("BOOL", "", !var1.GET().equals(var2.toStringVariable()), var1.getContext()); // raczej zwraca false'a
    }
    ...
    public Variable performOperation(BoolVariable var1, IntegerVariable var2) {
        return LegacyVariableFactory.createVariable("BOOL", "", var1.GET() != var2.toBool(), var1.getContext()); // zakładam, że 1 == TRUE
    }

    @Override
    public Variable performOperation(IntegerVariable var1, BoolVariable var2) {
        return LegacyVariableFactory.createVariable("BOOL", "", var1.GET() != var2.toInt(), var1.getContext()); // zakładam, że 1 == TRUE
    }
    ...
    public Variable performOperation(DoubleVariable var1, BoolVariable var2) {
        return LegacyVariableFactory.createVariable("BOOL", "", var1.GET() != var2.toDouble(), var1.getContext()); // zakładam, że 1 == TRUE
    }
}
