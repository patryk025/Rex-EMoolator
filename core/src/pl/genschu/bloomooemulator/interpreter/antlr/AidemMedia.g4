...
string
	:	QUOTEMARK ((literal | arithmetic? (number | floatNumber) | compare | SLASH | LPAREN | RPAREN | arithmetic | VARREF | STRUCTFIELD | SEPARATOR | iterator | expression | functionFire)+ | (variable (SLASH literal?)?) | string | bool)? QUOTEMARK
	;
