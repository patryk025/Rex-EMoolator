...
public class MultiplyOperation extends ArithmeticOperation {
    ...
    public Variable performOperation(BoolVariable var1, BoolVariable var2) {
        return LegacyVariableFactory.createVariable("BOOL", null, var1.GET() || var2.GET(), var1.getContext()); // Tutaj silnik wygląda, jakby robił alternatywę, albo to, albo tamto
    }

    @Override
    public Variable performOperation(BoolVariable var1, IntegerVariable var2) {
        return LegacyVariableFactory.createVariable("BOOL", null, var1.GET() || var2.toBool(), var1.getContext());
    }
