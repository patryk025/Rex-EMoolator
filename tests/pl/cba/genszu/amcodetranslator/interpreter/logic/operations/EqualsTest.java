...
public class EqualsTest {
    ...
    private Variable[] expectedBoolEquality;
    private Variable[] expectedStringEquality;
    private Variable[] expectedIntegerEquality;
    private Variable[] expectedDoubleEquality;

    public EqualsTest(String testSetName, Context context, Variable[] expectedBoolEquality, Variable[] expectedStringEquality, Variable[] expectedIntegerEquality, Variable[] expectedDoubleEquality) {
        this.testSetName = testSetName;
        this.context = context;
        this.expectedBoolEquality = expectedBoolEquality;
        this.expectedStringEquality = expectedStringEquality;
        this.expectedIntegerEquality = expectedIntegerEquality;
        this.expectedDoubleEquality = expectedDoubleEquality;
    }
    ...
    public void testBoolEquality() {
        ...
        assertEquals(expectedBoolEquality[0].toString(), result.toString());

        // Test BOOL ' STRING
        result = executeExpression("TEST2 ' TEST_COMPARE");
        assertEquals(expectedBoolEquality[1].toString(), result.toString());

        // Test BOOL ' INTEGER
        result = executeExpression("TEST2 ' TEST4_COMPARE");
        assertEquals(expectedBoolEquality[2].toString(), result.toString());

        // Test BOOL ' DOUBLE
        result = executeExpression("TEST2 ' TEST3_COMPARE");
        assertEquals(expectedBoolEquality[3].toString(), result.toString());
    }
    ...
    public void testStringEquality() {
        ...
        assertEquals(expectedStringEquality[0].toString(), result.toString());

        // Test STRING ' INTEGER
        result = executeExpression("TEST ' TEST4_COMPARE");
        assertEquals(expectedStringEquality[1].toString(), result.toString());

        // Test STRING ' DOUBLE
        result = executeExpression("TEST ' TEST3_COMPARE");
        assertEquals(expectedStringEquality[2].toString(), result.toString());

        // Test STRING ' BOOL
        result = executeExpression("TEST ' TEST2_COMPARE");
        assertEquals(expectedStringEquality[3].toString(), result.toString());
    }
    ...
    public void testIntegerEquality() {
        ...
        assertEquals(expectedIntegerEquality[0].toString(), result.toString());

        // Test INTEGER ' INTEGER
        result = executeExpression("TEST4 ' TEST4_COMPARE");
        assertEquals(expectedIntegerEquality[1].toString(), result.toString());

        // Test INTEGER ' DOUBLE
        result = executeExpression("TEST4 ' TEST3_COMPARE");
        assertEquals(expectedIntegerEquality[2].toString(), result.toString());

        // Test INTEGER ' BOOL
        result = executeExpression("TEST4 ' TEST2_COMPARE");
        assertEquals(expectedIntegerEquality[3].toString(), result.toString());
    }
    ...
    public void testDoubleEquality() {
        ...
        assertEquals(expectedDoubleEquality[0].toString(), result.toString());

        // Test DOUBLE ' INTEGER
        result = executeExpression("TEST3 ' TEST4_COMPARE");
        assertEquals(expectedDoubleEquality[1].toString(), result.toString());

        // Test DOUBLE ' DOUBLE
        result = executeExpression("TEST3 ' TEST3_COMPARE");
        assertEquals(expectedDoubleEquality[2].toString(), result.toString());

        // Test DOUBLE ' BOOL
        result = executeExpression("TEST3 ' TEST2_COMPARE");
        assertEquals(expectedDoubleEquality[3].toString(), result.toString());
    }
