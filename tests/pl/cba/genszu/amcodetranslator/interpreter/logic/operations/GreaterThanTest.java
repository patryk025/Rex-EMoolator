...
public class GreaterThanTest {
    ...
    private Variable[] expectedBoolGreaterThan;
    private Variable[] expectedStringGreaterThan;
    private Variable[] expectedIntegerGreaterThan;
    private Variable[] expectedDoubleGreaterThan;

    public GreaterThanTest(String testSetName, Context context, Variable[] expectedBoolGreaterThan, Variable[] expectedStringGreaterThan, Variable[] expectedIntegerGreaterThan, Variable[] expectedDoubleGreaterThan) {
        this.testSetName = testSetName;
        this.context = context;
        this.expectedBoolGreaterThan = expectedBoolGreaterThan;
        this.expectedStringGreaterThan = expectedStringGreaterThan;
        this.expectedIntegerGreaterThan = expectedIntegerGreaterThan;
        this.expectedDoubleGreaterThan = expectedDoubleGreaterThan;
    }
    ...
    @Test
    public void testBoolGreaterThan() {
        // Test BOOL > BOOL
        Variable result = executeExpression("TEST2 > TEST2_COMPARE");
        assertEquals(expectedBoolGreaterThan[0].toString(), result.toString());

        // Test BOOL > STRING
        result = executeExpression("TEST2 > TEST_COMPARE");
        assertEquals(expectedBoolGreaterThan[1].toString(), result.toString());

        // Test BOOL > INTEGER
        result = executeExpression("TEST2 > TEST4_COMPARE");
        assertEquals(expectedBoolGreaterThan[2].toString(), result.toString());

        // Test BOOL > DOUBLE
        result = executeExpression("TEST2 > TEST3_COMPARE");
        assertEquals(expectedBoolGreaterThan[3].toString(), result.toString());
    }
    ...
    public void testStringGreaterThan() {
        ...
        assertEquals(expectedStringGreaterThan[0].toString(), result.toString());

        // Test STRING > INTEGER
        result = executeExpression("TEST > TEST4_COMPARE");
        assertEquals(expectedStringGreaterThan[1].toString(), result.toString());

        // Test STRING > DOUBLE
        result = executeExpression("TEST > TEST3_COMPARE");
        assertEquals(expectedStringGreaterThan[2].toString(), result.toString());

        // Test STRING > BOOL
        result = executeExpression("TEST > TEST2_COMPARE");
        assertEquals(expectedStringGreaterThan[3].toString(), result.toString());
    }
    ...
    public void testIntegerGreaterThan() {
        ...
        assertEquals(expectedIntegerGreaterThan[0].toString(), result.toString());

        // Test INTEGER > INTEGER
        result = executeExpression("TEST4 > TEST4_COMPARE");
        assertEquals(expectedIntegerGreaterThan[1].toString(), result.toString());

        // Test INTEGER > DOUBLE
        result = executeExpression("TEST4 > TEST3_COMPARE");
        assertEquals(expectedIntegerGreaterThan[2].toString(), result.toString());

        // Test INTEGER > BOOL
        result = executeExpression("TEST4 > TEST2_COMPARE");
        assertEquals(expectedIntegerGreaterThan[3].toString(), result.toString());
    }
    ...
    public void testDoubleGreaterThan() {
        ...
        assertEquals(expectedDoubleGreaterThan[0].toString(), result.toString());

        // Test DOUBLE > INTEGER
        result = executeExpression("TEST3 > TEST4_COMPARE");
        assertEquals(expectedDoubleGreaterThan[1].toString(), result.toString());

        // Test DOUBLE > DOUBLE
        result = executeExpression("TEST3 > TEST3_COMPARE");
        assertEquals(expectedDoubleGreaterThan[2].toString(), result.toString());

        // Test DOUBLE > BOOL
        result = executeExpression("TEST3 > TEST2_COMPARE");
        assertEquals(expectedDoubleGreaterThan[3].toString(), result.toString());
    }
