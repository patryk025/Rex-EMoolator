...
public class SubtractionTest {
    ...
    private Variable[] expectedBoolSubtraction;
    private Variable[] expectedStringSubtraction;
    private Variable[] expectedIntegerSubtraction;
    private Variable[] expectedDoubleSubtraction;

    public SubtractionTest(String testSetName, Context context, Variable[] expectedBoolSubtraction, Variable[] expectedStringSubtraction, Variable[] expectedIntegerSubtraction, Variable[] expectedDoubleSubtraction) {
        this.testSetName = testSetName;
        this.context = context;
        this.expectedBoolSubtraction = expectedBoolSubtraction;
        this.expectedStringSubtraction = expectedStringSubtraction;
        this.expectedIntegerSubtraction = expectedIntegerSubtraction;
        this.expectedDoubleSubtraction = expectedDoubleSubtraction;
    }
        ...
        return Arrays.asList(new Object[][] {
                {
                    ...
                    new Variable[] {
                        ...
                        new DoubleVariable("", 0.5, contexts[0]),
                ...
                },
                {
                    ...
                    new Variable[] {
                            ...
                            new IntegerVariable("", -2, contexts[1]),
                            new IntegerVariable("", -2, contexts[1]),
                            new IntegerVariable("", 1, contexts[1])
                    },
                    new Variable[] {
                ...
                },
                {
                    ...
                    new Variable[]{
                            ...
                            new DoubleVariable("", 4.0, contexts[2]),
                ...
                },
                {
                    ...
                    new Variable[] {
                            ...
                            new IntegerVariable("", 6, contexts[3]),
                            new IntegerVariable("", 0, contexts[3]),
                            new IntegerVariable("", 1, contexts[3])
                    },
                    new Variable[] {
                            new DoubleVariable("", 6.5, contexts[3]),
                            new DoubleVariable("", 11.5, contexts[3]),
                            new DoubleVariable("", 5.49999, contexts[3]),
                            new DoubleVariable("", 6.5, contexts[3])
                    }
                }
        });
    ...
    @Test
    public void testBoolSubtraction() {
        // Test BOOL + BOOL
        Variable result = executeExpression("TEST2 - TEST2_COMPARE", "BOOL");
        assertEquals(expectedBoolSubtraction[0].toString(), result.toString());

        // Test BOOL + STRING
        result = executeExpression("TEST2 - TEST_COMPARE", "BOOL");
        assertEquals(expectedBoolSubtraction[1].toString(), result.toString());

        // Test BOOL + INTEGER
        result = executeExpression("TEST2 - TEST4_COMPARE", "BOOL");
        assertEquals(expectedBoolSubtraction[2].toString(), result.toString());

        // Test BOOL + DOUBLE
        result = executeExpression("TEST2 - TEST3_COMPARE", "BOOL");
        assertEquals(expectedBoolSubtraction[3].toString(), result.toString());
    }
    ...
    public void testStringSubtraction() {
        ...
        assertEquals(expectedStringSubtraction[0].toString(), result.toString());

        // Test STRING + INTEGER
        result = executeExpression("TEST - TEST4_COMPARE", "STRING");
        assertEquals(expectedStringSubtraction[1].toString(), result.toString());

        // Test STRING + DOUBLE
        result = executeExpression("TEST - TEST3_COMPARE", "STRING");
        assertEquals(expectedStringSubtraction[2].toString(), result.toString());

        // Test STRING + BOOL
        result = executeExpression("TEST - TEST2_COMPARE", "STRING");
        assertEquals(expectedStringSubtraction[3].toString(), result.toString());
    }
    ...
    public void testIntegerSubtraction() {
        ...
        assertEquals(expectedIntegerSubtraction[0].toString(), result.toString());

        // Test INTEGER + INTEGER
        result = executeExpression("TEST4 - TEST4_COMPARE", "INT");
        assertEquals(expectedIntegerSubtraction[1].toString(), result.toString());

        // Test INTEGER + DOUBLE
        result = executeExpression("TEST4 - TEST3_COMPARE", "INT");
        assertEquals(expectedIntegerSubtraction[2].toString(), result.toString());

        // Test INTEGER + BOOL
        result = executeExpression("TEST4 - TEST2_COMPARE", "INT");
        assertEquals(expectedIntegerSubtraction[3].toString(), result.toString());
    }
    ...
    public void testDoubleSubtraction() {
        ...
        assertEquals(expectedDoubleSubtraction[0].toString(), result.toString());

        // Test DOUBLE + INTEGER
        result = executeExpression("TEST3 - TEST4_COMPARE", "DOUBLE");
        assertEquals(expectedDoubleSubtraction[1].toString(), result.toString());

        // Test DOUBLE + DOUBLE
        result = executeExpression("TEST3 - TEST3_COMPARE", "DOUBLE");
        assertEquals(expectedDoubleSubtraction[2].toString(), result.toString());

        // Test DOUBLE + BOOL
        result = executeExpression("TEST3 - TEST2_COMPARE", "DOUBLE");
        assertEquals(expectedDoubleSubtraction[3].toString(), result.toString());
    }
